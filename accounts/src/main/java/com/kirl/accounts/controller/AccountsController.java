...
import com.kirl.accounts.dto.AccountsContactInfoDto;
...
public class AccountsController {
	...
	@Operation(
			...
			description = "Getting the build information of accounts microservice."
	)
	@ApiResponses({
			@ApiResponse(
					responseCode = "200",
	...
	@Operation(
			...
			description = "Getting the java version information of accounts microservice."
	)
	@ApiResponses({
			@ApiResponse(
					responseCode = "200",
	...
	@Operation(
			summary = "Get Contact info of the microservice ",
			description = "Getting the Contact information of accounts microservice."
	)
	@ApiResponses({
			@ApiResponse(
					responseCode = "200",
